...
（\texttt{massive\_nu.py}）。共動エネルギー $\varepsilon=\sqrt{q^2+a^2m^2}$ の運動量
積分で $\rho_{\rm ncdm}(a)$ を求め、相対論的（$\propto a^{-4}$）から非相対論的
（$\propto a^{-3}$）への遷移を捉える。今日の密度は $\Omega_{\rm ncdm}h^2\approx
\sum m_\nu/93~\mathrm{eV}$ を再現し、平坦条件で $\Omega_\Lambda$ が減るため $H(z)$ と
距離が変わる（$h$ 固定で $\sum m_\nu=0.06/0.12/0.30$~eV に対し $\Omega_\Lambda{:}\,
0.686\!\to\!0.684\!\to\!0.679$、$100\theta_*{:}\,1.034\!\to\!1.040$）。
